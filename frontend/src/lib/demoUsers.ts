...
export const demoUsers: UserPayload[] = [
  {
    profile: {
      ...
      goals: ["Build a 6-month emergency fund", "Save for a home down payment"],
      plannedBudget: {
        housing: 1700,
        food: 650,
        transport: 320,
  ...
  },
  {
    profile: {
      ...
      riskTolerance: "low",
      goals: ["Max out retirement contributions", "Invest for financial independence"],
      plannedBudget: {
        housing: 2200,
        food: 700,
        transport: 260,
  ...
  },
  {
    profile: {
      ...
      riskTolerance: "high",
      goals: ["Pay off debt aggressively", "Build an angel investing runway"],
      plannedBudget: {
        housing: 1900,
        food: 620,
        transport: 240,
